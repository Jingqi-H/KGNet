...
"""
dest的内容是 ___.py 文件里面 args.___ 后面接着的内容
"""
...
class BaseConfig(object):
    ...
    def _add_data(self):
        ...
        self.parser.add_argument('-co_m_p', '--continue_modle_path', dest='continue_modle_path', type=str,
                                 default=param['path_list']['continue_modle_path'], help='continue my modle path')
    ...
    def _add_train(self):
        ...
        self.parser.add_argument('-cmm', '--continue_my_model', action='store_true',
                                 help='wheather continue my trained model', dest='continue_my_model')
        # use_lr_decay默认是True
        self.parser.add_argument('-uld', '--use_lr_decay', action='store_false',
                                 help='wheather use learning rate decay', dest='use_lr_decay')
        self.parser.add_argument('-cl', '--control_lr', action='store_true',
                                 help='control learning rate', dest='control_lr')
        self.parser.add_argument('-sld', '--stop_lr_decay', type=int, default=param['stop_lr_decay'],
                                 help='stop_lr_decay', dest='stop_lr_decay')
    ...
    def _add_superparameter(self):
        ...
        self.parser.add_argument('-lr', '--learning_rate', metavar='LR', type=float, nargs='?',
        ...
        self.parser.add_argument('--p_attri', default=loss['loss_p']['p_attri'], type=float,
                                 help='the attribution embedding loss parameter', dest='p_attri')
